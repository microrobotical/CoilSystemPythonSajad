...
class SubThread(QThread):
    ...
    def examplePiecewiseFunction(self):
        ...
        while True:
            ...
            self.field.setField([fieldX,fieldY,fieldZ,0,0,0,0,0])
            if self.stopped:
                return
    ...
    def oni_cutting(self):
        ...
        while True:
            ...
            self.field.setField([fieldX,fieldY,0,0,0,0,0,0])
            if self.stopped:
                return
    ...
    def rotateYZ(self):
        ...
        while True:
            ...
            self.field.setField([0,fieldY,fieldZ,0,0,0,0,0])
            if self.stopped:
                return
    ...
    def rotateXZ(self):
        ...
        while True:
            ...
            fieldX = self.params[1] * cos(theta)
            fieldZ = self.params[1] * sin(theta)
            self.field.setField([fieldX,0,fieldZ,0,0,0,0,0])
            if self.stopped:
                return
